...
scale_factor=fx
points_3D = [
    gtsam.Point3(-0.005*fx, -0.005*fx, 0),  # Lower-left corner
    gtsam.Point3(0.005*fx, -0.005*fx, 0),   # Lower-right corner
    gtsam.Point3(0.005*fx, 0.005*fx, 0),    # Upper-right corner
    gtsam.Point3(-0.005*fx, 0.005*fx, 0)    # Upper-left corner
]
